...
var relatedProductIDs = function(productId) {
  ...
  return new Promise((resolve, reject) => {
    var server = '/products/'+productId+'/related';
    var options = {
      method:"get",
      url:server
    }
...
var relatedProductDetails = function(relatedIds) {
  ...
  return new Promise((resolve, reject) => {
    var server = '/products/related/details';
    var options = {
      method:"get",
      url:server,
      params: {
...
var outfitProductDetails = function(outfitIds) {
  ...
  return new Promise((resolve, reject) => {
    var server = '/products/outfit/details';
    var options = {
      method:"get",
      url:server,
      params: {
...
var productStyles = function(productId) {
  var server = '/products/'+productId+'/styles';
  return new Promise((resolve, reject) => {
  var options = {
    method:"get",
    url: server
